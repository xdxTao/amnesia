...
public class AccessToken {
    ...
    public static String getAccessToken(){
        if (accountToken.equals("") || expireDate == null || expireDate < System.currentTimeMillis()){
            ...
            expireDate = System.currentTimeMillis() + (Integer.parseInt(jsonNode.get("expires_in").toString()) * 1000);
        }
        return accountToken;
    }
}